...
public void instanciaDB() {
		...
		Chamado cha1 = new Chamado(null, LocalDate.now(), Prioridade.MEDIA, Status.ANDAMENTO,"Chamdo 01", "Primeiro chamado", cli1, tec1);
		Chamado cha2 = new Chamado(null, LocalDate.now(), Prioridade.ALTA, Status.ANDAMENTO,"Chamdo 02", "Segundo chamado", cli2, tec2);
